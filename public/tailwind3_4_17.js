...
(() => {
		...
		for (let a = r + 1; a < t.length; a++)
			if (((o = t.charCodeAt(a)), 92 === o)) a += 1;
				...
				if (
					...
					throw new Error(
						`Unterminated string: ${
							t.slice(r, a + 1) + String.fromCharCode(n)
						}`
					);
				if (o === e || (13 === o && t.charCodeAt(a + 1) === e))
					throw new Error(
						`Unterminated string: ${
							t.slice(r, a) + String.fromCharCode(n)
						}`
					);
			}
		return r;
		...
		function p(e, u, h = {}, m = 0) {
			if ("declaration" === e.kind) {
				...
				if ("animation" === e.property)
					for (let t of U(e.value)) s.add(t);
	...
	var se = {
		color: function (e) {
			return (
				35 === e.charCodeAt(0) || le.test(e) || ie.has(e.toLowerCase())
			);
		},
		length: ye,
		percentage: we,
	...
	function rt(e) {
		let t = (function (e) {
				...
				function d({ negative: t }) {
					return (r) => {
						...
						if ("arbitrary" === r.value.kind) {
							n = r.value.value;
							let e =
								r.value.dataType ?? ce(n, ["angle", "vector"]);
							if ("vector" === e)
				...
				let p = () =>
					T([Ue("--tw-scroll-snap-strictness", "proximity", "*")]);
				...
				n("grid-flow-row", [["grid-auto-flow", "row"]]),
					...
					i("gap-x", ["--gap", "--spacing"], (e) => [
						S("column-gap", e),
					]),
					i("gap-y", ["--gap", "--spacing"], (e) => [
						S("row-gap", e),
					]),
					i(
						"space-x",
			...
			r = (function (e) {
				...
				r("first", ["&:first-child"]),
					...
					t.functional("aria", (e, t) => {
						...
						"arbitrary" === t.value.kind
							? (e.nodes = [
									$(`&[aria-${Qe(t.value.value)}]`, e.nodes),
							  ])
							: (e.nodes = [
									$(
										`&[aria-${t.value.value}="true"]`,
										e.nodes
									),
							  ]);
					}),
					...
					t.functional("nth-last", (e, t) => {
						if (
							...
							return null;
						e.nodes = [
							$(`&:nth-last-child(${t.value.value})`, e.nodes),
						];
					}),
					t.functional("nth-of-type", (e, t) => {
						if (
							...
							return null;
						e.nodes = [
							$(`&:nth-of-type(${t.value.value})`, e.nodes),
						];
					}),
					t.functional("nth-last-of-type", (e, t) => {
						if (
							...
							return null;
						e.nodes = [
							$(`&:nth-last-of-type(${t.value.value})`, e.nodes),
						];
					}),
					t.functional(
						"supports",
			...
			s = {
				...
				getClassOrder(e) {
					return (function (e, t) {
						let { astNodes: r, nodeSorting: n } = ot(
								Array.from(t),
								e
							),
			...
			for (let r of n) {
				...
				if (0 !== n.length) {
					...
					for (let { node: t, propertySort: i } of n) {
						...
						o.set(t, { properties: i, variants: n, candidate: e }),
							a.push(t);
					}
				}
			}
		...
		return (
			a.sort((e, t) => {
				...
				for (
					...
					a += 1;
				return (
					(r.properties.order[a] ?? 1 / 0) -
						(n.properties.order[a] ?? 1 / 0) ||
			...
			let r = 5;
			{
				...
				n &&
					...
					e.theme.add(
						...
						ft(t.fontFamily.sans, "fontFeatureSettings") ??
							"normal",
						r
					),
					e.theme.add(
						"--default-font-variation-settings",
						ft(t.fontFamily.sans, "fontVariationSettings") ??
							"normal",
						r
					));
			}
			{
				...
				n &&
					...
					e.theme.add(
						...
						ft(t.fontFamily.mono, "fontFeatureSettings") ??
							"normal",
						r
					),
					e.theme.add(
						"--default-mono-font-variation-settings",
						ft(t.fontFamily.mono, "fontVariationSettings") ??
							"normal",
						r
					));
			}
	...
	function Ct(e, t, r) {
		return function (n, o) {
			let a = n.lastIndexOf("/"),
				l = null;
			-1 !== a &&
				((l = n.slice(a + 1).trim()), (n = n.slice(0, a).trim()));
			let s = (() => {
				let o = At(n),
					[a, l] = (function (e, t) {
			...
			matchUtilities(t, r) {
				...
				for (let [a, i] of Object.entries(t)) {
					...
					r?.supportsNegativeValues &&
						e.utilities.functional(`-${a}`, t({ negative: !0 }), {
							types: o,
						}),
						e.utilities.functional(a, t({ negative: !1 }), {
							types: o,
						}),
			...
			if ("@plugin" === e.name) {
				...
				for (let t of e.nodes ?? []) {
					...
					let e = q(t.value, ",").map((e) => {
						...
						if ("{" === e[0] && "}" === e[e.length - 1])
							throw new Error(
								`Unexpected \`@plugin\` option: Value of declaration \`${N(
									[t]
												...
												if (
													...
													console.warn(
														`Unsupported bare value data type: "${
															t.value
														}".\nOnly valid data types are: ${Me.map(
															(e) => `"${e}"`
														).join(", ")}.\n`
													);
													let r = t.value,
									...
									r.utilities.suggest(t.slice(0, -2), () => {
										...
										for (let [
											...
											if (i) o.push(...Oe);
												...
												for (let e of Oe)
													Ae(e) && o.push(e);
											for (let e of r.theme.keysInNamespaces(
												s
											))
												o.push(
													e.replace(
